using PotikotTools.Commands.Editor;
using UnityEditor;
using UnityEngine;
...
namespace PotikotTools.RuntimeConsole.Editor
{
    public class ConsolePreferencesWindow : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            {
                _preferences = ConsolePreferences.PreferencesSO;
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("Open Command Handler Preferences"))
                CommandHandlerPreferencesWindow.Open();
        }
